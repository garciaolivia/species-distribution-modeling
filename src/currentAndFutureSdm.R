...
# mask is the raster object determines the area we're interested in
...
# create a grid of measurements for the psuedo absence points
...
# create a spatial pixels data frame
